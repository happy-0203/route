package cn.com.za.compiler.utils;
...
public class Consts {
    ...
    public static final ClassName ROUTER = ClassName.get("cn.com.za.router.core", "ZaRouter");

    public static final String ARGUMENTS_NAME = "moduleName";
    public static final String ANN_TYPE_ROUTE = "cn.com.za.annotation.Route";
    public static final String ANN_TYPE_Extra = "com.za.router.annotation.Extra";


    public static final String IROUTE_GROUP = "cn.com.za.router.core.template.IRouteGroup";
    public static final String IROUTE_ROOT = "cn.com.za.router.core.template.IRouteRoot";
    ...
    public static final String ISERVICE = "cn.com.za.router.core.template.IService";
    ...
    public static final String PROJECT = "ZaRouter";
    ...
    public static final String PACKAGE_OF_GENERATE_FILE = "com.za.router.routes";
